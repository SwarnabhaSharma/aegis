...
| A-008 | Local LLM via OpenAI-compat server, swappable provider interface, used in ≤2 places (hypothesis summary, recommend-actions). Code default llama.cpp `:8080`; live since 2026-09-23 = LM Studio `:1234` + Spark-X2.5-4B | User decision 2026-08-18 (LM Studio superseded, then re-adopted for Spark swap 2026-09-23) | MEDIUM | Base URL swap only; interface unchanged | Phase D | VALIDATED |
